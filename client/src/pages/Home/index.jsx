...
const HomePage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-5 bg-gray-200">
      <div className="w-full max-w-md p-10 bg-white rounded-lg shadow-lg flex flex-col items-center border border-gray-300 pb-[5em] translate-y-[-10%]">
        <img
          src={logo}
          alt="ALLOC8 Logo"
          className="h-[40px] border-b-2 pb-2 mb-1"
        />
