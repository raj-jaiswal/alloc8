...
const SuccessPage = () => {
  ...
  useEffect(() => {
    // TODO: Replace with fetch call to get room details
    setStudData({
      name: "Hemant Kumar",
      JEEAdvRollNo: "1234",
      hostel: "cvr",
      ...
      occupancy: "3",
      roommates: [
        { JEEAdvRollNo: "1234", name: "Hemant Kumar" },
        { JEEAdvRollNo: "1234", name: "Hemant Kumar" },
      ],
    });
    setLoading(false);
            ...
            <div className="p-5 text-xl font-mono border-2 my-5 capitalize">
              ...
              <div>
                ...
                {studData?.roommates?.map((roommate) => {
                  return (
                    <div key={roommate.JEEAdvRollNo} className="px-10">
                      {roommate?.JEEAdvRollNo} - {roommate?.name}
                    </div>
                  );
                })}
              </div>
